...
//Código genero
  ...
  begin
    Messagedlg('O generos é um campo obrigatório', mtinformation,[mbok],0);
...
if (DBEdit3.Text='') then
  begin
    Messagedlg('O nome é um campo obrigatório', mtinformation,[mbok],0);
    DBEdit3.SetFocus;
    Exit;
  end;
...
if (DBEdit4.Text='') then
  begin
    Messagedlg('A duração é um campo obrigatório', mtinformation,[mbok],0);
    DBEdit4.SetFocus;
    Exit;
  end;
